...
from api.routes.assets_write import router as assets_write_router
...
from api.routes.auth_extras import router as auth_extras_router
from api.routes.agent_health import router as agent_health_router
...
from api.routes.network_reach_routes import router as network_reach_router
...
app.include_router(assets_write_router, prefix="/api/assets",        tags=["assets"])
...
app.include_router(network_reach_router, prefix="/api/network-reach", tags=["network-reach"])
